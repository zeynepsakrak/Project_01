...
import java.io.PrintStream;
 ...
 public class test1 {
     ...
     public void totalLetterCountCheck1() {
         ...
         P11_MustafaErdemK.main(new String[0]);
     ...
     public void age1() {
         ...
         P01_OguzhanK.main(new String[0]);
     ...
     public void twoString1() {
         ...
         provideInput(testString);
         P12_AbdullahMenafE.main(new String[0]);
     ...
     public void countE1() {
         ...
         provideInput(testString);
         P03_AbdullahErdemE.main(new String[0]);
